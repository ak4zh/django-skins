...
def template(request):
    ...
    context = {
        ...
        # view names
        "login_view": getattr(settings, 'DJANGO_SKINS_LOGIN_VIEW_NAME', 'account_login'),
        "logout_view": getattr(settings, 'DJANGO_SKINS_LOGOUT_VIEW_NAME', 'account_logout'),
        "signup_view": getattr(settings, 'DJANGO_SKINS_SIGNUP_VIEW_NAME', 'account_signup'),
